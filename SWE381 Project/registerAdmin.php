...
<body class="text-center">
  ...
  <main class="form-signin">
    <form action="handle.php" method="POST">
      ...
      <label for="floatingInput">Select your restraunt</label>
      <select class="custom-select" name="selection" required>
        
        <option value="McDonalds">McDonalds</option>
        <option value="Herfy">Herfy</option>
        ...
        <option value="CasaPasta">CasaPasta</option>
        <option value="Kudu">Kudu</option>
        <option value="Yummywok">Yummywok</option>
      ...
      <div class = "form-floating">
      <p><a href="registerAdminNew.php">restaurant is not there?  register here</a></p>
    </div>
      <p class="mt-5 mb-3 text-muted">&copy; 2021–2022</p>

      <input type="hidden" name="registerAdmin">
      <?php
